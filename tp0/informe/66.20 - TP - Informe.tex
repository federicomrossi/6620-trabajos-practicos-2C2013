...
\section{Compilación}
	...
	La herramienta para compilar el código en lenguaje C será el \textit{GCC}. Para tratar de equiparar al máximo el \textit{S} generado por ambas implementaciones, se utilizará el flag de gcc ``-O0'' para que no realice optimizaciones sobre el código en lenguaje C.
	\par
